...
from curiosity_gym.utils.constants import (
    ACTIONS_ENEMY,
    ACTIONS_SPARSEENV,
    ACTIONS_SMALLREWARDS,
    ACTIONS_DISTRACTIVEENV,
)
...
class TestSparseEnv(unittest.TestCase):
    ...
    def test_open_door_without_key(self) -> None:
        ...
        self.assertEqual(
            door.state,
            2,
            f"Unexpected door state {door.state}. " f"Expected it to be closed (2).",
        )
    ...
    def test_open_door_with_key(self) -> None:
        ...
        self.assertEqual(
            door.state,
            0,
            f"Unexpected door state {door.state}. " f"Expected it to be open (0).",
        )
    ...
    def test_sparseenv_target(self) -> None:
        ...
        self.assertTrue(
            terminated, "Termination by completing sparse environment failed."
        )
...
class TestDistractiveEnv(unittest.TestCase):
    ...
    def test_distractiveenv_target(self) -> None:
        ...
        Expected: Maximum reward, episode termination.
        """
        for a in ACTIONS_DISTRACTIVEENV:
            _, reward, terminated, _, _ = env_distractive.step(a)
        self.assertEqual(
            reward,
            self.reward_max,
        ...
        self.assertTrue(
            terminated, "Termination by completing distractive environment failed."
        )
...
class TestMultitaskEnv1(unittest.TestCase):
    ...
    def test_multitask_1_while_active(self) -> None:
        ...
        self.assertTrue(
            terminated, "Termination by completing multitask 1 environment failed."
        )
...
class TestMultitaskEnv2(unittest.TestCase):
    ...
    def test_push_ball(self) -> None:
        ...
        self.assertListEqual(
            ...
            [13, 3],
            f"Unexpected ball position after push {ball.position}. " "Expected [13,3]",
        )
        self.assertListEqual(
            self.agent.position.tolist(),
            ball.start_position.tolist(),
    ...
    def test_multitask_2_while_active(self):
        ...
        self.assertTrue(
            terminated, "Termination by completing multitask 2 environment failed."
        )
